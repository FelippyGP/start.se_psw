...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('empresarios', '0002_documento_metricas'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AS', 'Aguardando assinatura'), ('PE', 'Proposta enviada'), ('PA', 'Propsta aceita'), ('PR', 'Proposta recusada')], default='AS', max_length=2)),
